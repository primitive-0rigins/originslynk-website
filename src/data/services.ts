...
export const tier3Setup: Service = {
  ...
  includes: [
    ...
    'Dedicated OriginsLynk-managed workflow server',
    'Remote administration and automated monitoring',
    'Backup verification, routine maintenance, and failure investigation',
    'Weekly review of managed workflow server health, backup results, and workflow execution records',
  ...
  clientResponsibilities: [
    ...
    'Return the managed workflow server when managed service ends',
  ],
  originsLynkResponsibilities: [
    'Own and remotely administer the dedicated managed workflow server',
